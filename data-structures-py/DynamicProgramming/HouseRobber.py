...
class Solution:
    def rob(self, nums: List[int]) -> int:
      ...
      for n in nums:
        # create temp variable and set to the max comparing current rob1 + n or rob2
        temp = max(rob1 + n, rob2)
        rob1 = rob2
        rob2 = temp
      # our rob2 variable will reach the end and you should have the max value inside of it
      return rob2